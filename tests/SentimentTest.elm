...
tests : Test
tests = 
  suite "Sentiment Tests"
    -- ex1
    [ defaultTest (assertEqual -6 ex1.score)
    , defaultTest (assertEqual -1.5 ex1.comparative)
    , defaultTest (assertEqual 4 (List.length ex1.tokens))
    , defaultTest (assertEqual 2 (List.length ex1.words))
    -- ex2
    , defaultTest (assertEqual 1 ex2.score)
    , defaultTest (assertEqual 0.25 ex2.comparative)
    , defaultTest (assertEqual 4 (List.length ex2.tokens))
    , defaultTest (assertEqual 1 (List.length ex2.words))
    -- ex3
    , defaultTest (assertEqual -2 ex3.score)
    , defaultTest (assertEqual -2 ex3.comparative)
    , defaultTest (assertEqual 1 (List.length ex3.tokens))
    , defaultTest (assertEqual 1 (List.length ex3.words))
    -- ex4
    , defaultTest (assertEqual 0 ex4.score)
    , defaultTest (assertEqual 0 ex4.comparative)
    , defaultTest (assertEqual 1 (List.length ex4.tokens))
    , defaultTest (assertEqual 0 (List.length ex4.words))
    -- ex5
    , defaultTest (assertEqual 100 ex5.score)
    , defaultTest (assertEqual 25 ex5.comparative)
    , defaultTest (assertEqual 4 (List.length ex5.tokens))
    , defaultTest (assertEqual 1 (List.length ex5.words))
    -- ex6
    , defaultTest (assertEqual -7 ex6.score)
    -- , defaultTest (assertEqual 0 ex6.comparative)
    , defaultTest (assertEqual 1416 (List.length ex6.tokens))
    , defaultTest (assertEqual 72 (List.length ex6.words))
    ]
